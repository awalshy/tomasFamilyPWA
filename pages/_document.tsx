    ...
    return (
      <Html>
        <Head>
          ...
          <link rel='apple-touch-icon' sizes='152x152' href='/icons/icon-dark-512.png' />
          <link rel='apple-touch-icon' sizes='192x192' href='/icons/icon-dark-192.png' />

          <link rel='icon' type='image/png' sizes='48x48' href='/icons/icon-dark-48.png' />
